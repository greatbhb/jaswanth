...
public class RegisterTest {
	WebDriver chrome;
	  ...
	  public void register() {
		  ...
		  email.sendKeys("jaswanthallu@gmail.com");
		  ...
		  add.sendKeys("tadipatri");
		  WebElement city = chrome.findElement(By.id("city"));
		  city.sendKeys("tadipatri");
